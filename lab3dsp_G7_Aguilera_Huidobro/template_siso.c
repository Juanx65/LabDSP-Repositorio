 ...
 *
 *         double y1 = funcion(double u1)
 *
 *    Simulink version           : 10.3 (R2021a) 14-Nov-2020
 *    C source code generated on : 25-May-2021 16:06:38
 *
...
/**
     ...
     def.SourceFiles = {'filterBiquad.c'};
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "funcion", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
