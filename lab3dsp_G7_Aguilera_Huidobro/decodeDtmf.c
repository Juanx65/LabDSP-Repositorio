 ...
 *
 *         void decodeDtmf(double u1, int32 y1[1] )
 *
 *    Simulink version           : 10.3 (R2021a) 14-Nov-2020
 *    C source code generated on : 04-Jun-2021 02:29:31
 *
...
/**
     ...
     def.OutputFcnSpec = 'void decodeDtmf(double u1, int32 y1[1] )';
...
#define S_FUNCTION_NAME  decodeDtmf
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "decodeDtmf", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
