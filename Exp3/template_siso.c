 ...
 *
 *         double y1 = retornar_salida(double u1, double u2)
 *
 *    Simulink version           : 10.3 (R2021a) 14-Nov-2020
 *    C source code generated on : 03-Jun-2021 21:49:14
 *
...
#define S_FUNCTION_NAME  template_siso
...
static void mdlInitializeSizes(SimStruct *S)
{
    ...
    if (ssRTWGenIsCodeGen(S) || ssGetSimMode(S)==SS_SIMMODE_EXTERNAL) {
        ...
        ssRegMdlInfo(S, "retornar_salida", MDL_INFO_ID_RESERVED, 0, 0, ssGetPath(S));
    } /* if */
