...
#endif
/*****************************************************************************/
/* Par�metros de configuraci�n del CODEC */
...
/*
 * Selecci�n de entrada de audio para el CODEC:
 * LCDK_LINE_INPUT  : Entrada estereo
 * LCDK_MIC_INPUT   : Entrada estereo con polarizaci�n de Microfonos
 */
...
/*
 * Atenuaci�n de salida del CODEC:
 * DAC_ATTEN_0DB
 * DAC_ATTEN_3DB
 * DAC_ATTEN_6DB
 * DAC_ATTEN_9DB
...
/*---------------------------------------------------------------------------*/
/* Define perido de muestreo de audio TS en segundos seg�n CODEC_FS */
